...
export const createCategory = form(async (form) => {
  const { locals: { db } } = getRequestEvent()
...
export const createCategoriesBulk = form(async (form) => {
  const { locals: { db } } = getRequestEvent()
...
export const updateCategory = form(async (form) => {
  const { locals: { db } } = getRequestEvent()
...
export const deleteCategory = form(async (form) => {
  const { locals: { db } } = getRequestEvent()
  const categoryId = form.get('categoryId') as string
